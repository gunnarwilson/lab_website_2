...
*/
    function loadStatsPage() {
        ...
        for (var r = 2; r < total; r++) {
            var a = table.rows[r].cells[2].innerHTML;
            a_value = parseInt(a); //cast as int
            var b = table.rows[r].cells[3].innerHTML;
            b_value = parseInt(b); //cast as int
            if(a_value < b_value) {
                table.rows[r].cells[4].innerHTML = table.rows[r].cells[1].innerHTML;
                losses.innerHTML++;
            }
            else {
                table.rows[r].cells[4].innerHTML = "CU";
                wins.innerHTML++;
            }
...
*/
    ...
    function loadPlayersPage() {
        var a = " ";
        for(var i = 0; i < 4; i++) {
            a += '<a href="#" onclick="switchPlayers('+ i +')">' + players[i].name + ' </a><br/> ';
        }
